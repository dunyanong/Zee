      ...
      >
        <Box>
          <Heading as="h1" color="brand.purple">
            Check out where you are at your goals
          </Heading>
          <Box pt={5}>
            ...
            <Box>
              <Box my={3}>
                <Flex justifyContent="space-between">
                  <Text maxW="150">
                    Necessities <WarningIcon color="red.500" />
                  </Text>
                  <Text maxW="150">RM 1300/1500</Text>
                </Flex>
                <MultiProgress
                  className="progressBarCustom"
                  elements={[
                    {
                      value: 65,
                      color: "#722464",
              ...
              <Box my={3}>
                <Flex justifyContent="space-between">
                  <Text maxW="150">
                    Wants <WarningIcon color="red.500" />
                  </Text>
              ...
              <Box padding="0 5px 0 5px">
                <Flex>
                  <Box
                    ...
                    width="1rem"
                    borderRadius="200px"
                    backgroundColor="#722464"
                  ></Box>
                  <Text padding="0 5px" fontSize="xs">
                    Last Week
                  </Text>
                </Flex>
              </Box>
