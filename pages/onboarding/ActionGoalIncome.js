  ...
  return (
    <div>
      ...
      <main className="min-h-screen bg-cyan-400 px-12 py-10 h-max">
        ...
        <h1 className="text-pink-500 text-xl py-5 md:text-2xl max-w-xl mx-auto font-extrabold">
          What is your monthly income?
        </h1>

        <div
          type="button"
          className="text-white font-extrabold bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 rounded-lg text-xl px-5 py-4 text-center mb-2"
        >
          RM 0.00
        </div>
